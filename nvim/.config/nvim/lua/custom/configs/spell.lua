...
vim.keymap.set('n', "<leader>zn", function() add_word_to_lang("nl") end, { desc = "Add word to Dutch" })
vim.keymap.set('n', "<leader>ze", function() add_word_to_lang("en") end, { desc = "Add word to English" })
